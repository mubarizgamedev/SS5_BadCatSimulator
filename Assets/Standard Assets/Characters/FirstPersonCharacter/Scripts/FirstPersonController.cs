...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] GameObject jumpAnimation;
        [SerializeField] GameObject stillHandsAnimation;
        [SerializeField] AudioClip jumpSound;

        [SerializeField] Animator catWalkHandAnimator;

        public static Action OnJump;
        public static Action OnLandOnGround;
        ...
        {
            Debug.Log("Cat landed after jump");
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded)
            {
                ...
                if (m_Jump)
                {
                    ...
                    stillHandsAnimation.SetActive(false);
                    OnJump?.Invoke();
            ...
            currentSpeed = m_MoveDir;
            currSpeed = currentSpeed.magnitude;
